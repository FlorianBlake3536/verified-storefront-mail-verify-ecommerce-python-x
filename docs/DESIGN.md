...
> Design notes for **verified-storefront-mail-verify-ecommerce-python-x** — a runnable python example that Email-verified checkout, receipts, fulfillment, and delivery lookup in a typed Python service.
...
- **Feature code** — the actual task: verified-checkout-email.
